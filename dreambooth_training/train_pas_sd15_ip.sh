...
export WANDB_RUN_GROUP="passengers_sd15_inpaint"
# ---------------------------
# Hugging Face Hub repo name for the fine-tuned model
HF_MODEL_ID="camgitblame/passengers_sd15_inpaint"
# Choose the correct INPAINTING base model
BASE_MODEL="runwayml/stable-diffusion-inpainting"   # SD 1.5 inpaint, 512px
# Paths
INSTANCE_DIR="passengers/data"                 
OUTPUT_DIR="passengers/passengers_sd15_inpaint"
