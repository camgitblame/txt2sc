...
The output videos of all models and full sets of training images used for DreamBooth are available in our project pages. 
...
├── dreambooth_data/                         # Training images used for DreamBooth  
